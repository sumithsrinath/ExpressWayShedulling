...
<?php
	$to = "samarasingha0784528396@gmail.com";
	$message = 
	"<h2><center>PAYMENT INFO</center></h2>
	<h3><center>DEPARTURE</center></h3>
	<i>Medallion Transport, M/V Lady of All Nations</i>
	";
$subject = "Booking Details";
if(mail($to,$subject,$message)){
	echo "<script> alert('Your Email Successfull')</script>";
}
else{
	echo "<script> alert('Your Email Not Successfull')</script>";
}
